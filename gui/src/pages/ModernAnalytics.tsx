  ...
  return (
    <div className="min-h-screen p-4 sm:p-6 lg:p-8 space-y-6 lg:space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4 sm:gap-0">
        <div>
          <h1 className="text-3xl sm:text-4xl font-bold modern-heading mb-2">
            Analytics
          </h1>
          <p className="text-lg sm:text-xl modern-subheading">
      ...
      {error ? (
        ...
        <>
          ...
          <div className="modern-card">
            ...
            <div className="text-center">
              <div className="text-base sm:text-lg modern-subheading mb-2">Overall Data Completeness</div>
              <div className="text-3xl sm:text-4xl lg:text-5xl font-bold modern-heading text-purple-400">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            <div className="modern-card text-center">
              ...
              <p className="text-2xl sm:text-3xl font-bold modern-heading">
          ...
          {/* Top Brands Chart */}
          <div className="modern-card">
            <h2 className="text-xl sm:text-2xl font-bold modern-heading mb-4 sm:mb-6">Top Brands by Volume</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
            <div className="modern-card">
              <h3 className="text-lg sm:text-xl font-bold modern-heading mb-4 sm:mb-6">Performance Insights</h3>
