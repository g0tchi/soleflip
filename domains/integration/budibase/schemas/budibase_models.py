...
class BudibaseDataSource(BaseModel):
    ...
    queries: Dict[str, Dict[str, Any]] = Field(default_factory=dict, description="Predefined queries")
...
class BudibaseComponent(BaseModel):
    ...
    children: List["BudibaseComponent"] = Field(default_factory=list, description="Child components")
...
class BudibaseScreen(BaseModel):
    ...
    components: List[BudibaseComponent] = Field(default_factory=list, description="Screen components")
...
class BudibaseApp(BaseModel):
    ...
    roles: List[Dict[str, Any]] = Field(default_factory=list, description="User roles and permissions")
...
class BudibaseValidationResult(BaseModel):
    ...
    api_compatibility: Dict[str, bool] = Field(default_factory=dict, description="API endpoint compatibility")
    missing_endpoints: List[str] = Field(default_factory=list, description="Missing API endpoints")
    deprecated_features: List[str] = Field(default_factory=list, description="Deprecated features used")
