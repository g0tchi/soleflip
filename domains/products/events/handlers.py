...
class ProductEventHandler:
    ...
    def _register_handlers(self):
        ...
        subscribe_to_event(
            ProductCreatedEvent, self.handle_product_created, "products.product_created"
        )
        subscribe_to_event(
            ProductUpdatedEvent, self.handle_product_updated, "products.product_updated"
        )

        # Listen to integration events that affect products
        subscribe_to_event(
            ImportBatchCompletedEvent, self.handle_import_completed, "products.import_completed"
        )
