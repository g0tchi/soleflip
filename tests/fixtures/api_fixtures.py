    ...
    with patch('domains.integration.services.stockx_service.StockXService') as mock_stockx:
        ...
        with patch('shared.utils.email_service.EmailService') as mock_email:
            ...
            with patch('shared.utils.file_service.FileService') as mock_file:
                ...
                file_instance.upload_file.return_value = {"file_id": "test-file-123", "url": "https://test.com/file.csv"}
...
def mock_database_operations():
    ...
    with patch('shared.database.connection.DatabaseManager.execute_transaction') as mock_transaction:
        mock_transaction.return_value = True
        
        with patch('shared.database.session_manager.SessionManager.cleanup_expired_sessions') as mock_cleanup:
...
class ResponseValidator:
    ...
    def validate_error_response(response_data: Dict[str, Any], expected_error_code: str = None):
        ...
        if expected_error_code:
            assert error.get("code") == expected_error_code, f"Expected error code '{expected_error_code}'"
