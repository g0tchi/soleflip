...
async def test_get_historical_orders_service_error(test_client: AsyncClient, mock_stockx_service):
    ...
    """
    # Arrange
    mock_stockx_service.get_historical_orders.side_effect = Exception("A wild historical error appeared!")

    # Act
    response = await test_client.get("/api/v1/orders/stockx-history?fromDate=2024-01-01&toDate=2024-01-31")
