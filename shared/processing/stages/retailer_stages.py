...
class RetailerParsingStage:
    ...
    def __init__(self):
        ...
        self.optional_fields = ['description', 'category', 'size', 'color', 'material', 'stock_quantity']
    ...
    async def cleanup(self, context: ProcessingContext) -> None:
        ...
        logger.info(
            "Cleaning up retailer parsing stage",
            batch_id=str(context.batch_id)
        )
    ...
    async def _parse_retailer_record(self, raw_record: Dict[str, Any], source_type: str) -> Optional[Dict[str, Any]]:
            ...
            for i, record in enumerate(chunk_data):
                try:
                    ...
                    if product:
                        ...
                        # Publish events
                        await publish_event(ProductCreatedEvent(
