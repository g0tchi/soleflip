            ...
            if is_limited:
                ...
                return JSONResponse(
                    ...
                    headers={
                        ...
                        "X-RateLimit-Remaining": str(max(0, self.requests_per_minute - limit_info.get("current", 0))),
...
class CSRFProtectionMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next: Callable) -> Response:
        ...
        if (request.method in self.safe_methods or 
            ...
            if (not token_from_header or 
                not token_from_cookie or 
                token_from_header != token_from_cookie or
                not self._validate_csrf_token(token_from_header)):
                ...
                logger.warning(
                    ...
                    tokens_match=token_from_header == token_from_cookie if token_from_header and token_from_cookie else False
                )
