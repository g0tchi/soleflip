...
class DataTransformer:
    ...
    def transform_batch(self, source_data_list: List[Dict[str, Any]]) -> tuple[List[Dict[str, Any]], List[str]]:
    ...
    def __init__(self):
        rules = [
            TransformationRule(
                ...
                target_field="external_order_id",
                required=True
            ),
            TransformationRule(
...
class ValidationTransformer:
    ...
    def validate_and_clean(
        data: Dict[str, Any], 
        validation_rules: Dict[str, Callable[[Any], Any]]
...
class BulkDataProcessor:
    ...
    async def process_in_batches(
        ...
        logger.info("Starting batch processing", total_records=total_records, batch_size=self.batch_size)
        ...
        for i in range(0, total_records, self.batch_size):
            ...
            try:
                logger.debug("Processing batch", batch_num=batch_num, total_batches=total_batches, batch_size=len(batch))
