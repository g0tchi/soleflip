...
class DatabaseConfig(BaseSettings):
    ...
    def validate_database_url(cls, v):
        ...
        if not v or not v.startswith(("postgresql://", "postgresql+asyncpg://", "sqlite://", "sqlite+aiosqlite://")):
...
class SecurityConfig(BaseSettings):
    ...
    def validate_encryption_key(cls, v):
        ...
        try:
            ...
            raise ValueError("FIELD_ENCRYPTION_KEY must be a valid Fernet key (32-byte base64-encoded string)")
...
class APIConfig(BaseSettings):
    ...
    description: str = Field(default="Professional sneaker resale management system", env="API_DESCRIPTION")
...
class ExternalServiceConfig(BaseSettings):
    ...
    stockx_auth_url: str = Field(default="https://accounts.stockx.com/oauth/token", env="STOCKX_AUTH_URL")
...
class MonitoringConfig(BaseSettings):
    ...
    sentry_traces_sample_rate: float = Field(default=0.1, ge=0.0, le=1.0, env="SENTRY_TRACES_SAMPLE_RATE")
