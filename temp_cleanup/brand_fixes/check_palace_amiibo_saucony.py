...
async def check_palace_amiibo_saucony():
    ...
    try:
        brands_to_check = [
            {
                'name': 'Palace',
                'search_patterns': ['%palace%']
            },
            {
                'name': 'Amiibo', 
                'search_patterns': ['%amiibo%']
            },
            {
                'name': 'Saucony',
                'search_patterns': ['%saucony%']
            }
        ]
        ...
        print(f"\n=== Summary ===")
        print("Palace, Amiibo, and Saucony brand analysis completed!")
        
    except Exception as e:
        print(f"Error checking Palace, Amiibo, and Saucony: {e}")
        import traceback
        traceback.print_exc()
    finally:
        await conn.close()
...
if __name__ == "__main__":
    asyncio.run(check_palace_amiibo_saucony())