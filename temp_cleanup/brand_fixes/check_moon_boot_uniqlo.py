...
async def check_moon_boot_uniqlo():
    ...
    try:
        ...
        print(f"\n=== Summary ===")
        print("Moon Boot and Uniqlo brand analysis completed!")
        
    except Exception as e:
        print(f"Error checking Moon Boot and Uniqlo: {e}")
        import traceback
        traceback.print_exc()
    finally:
        await conn.close()
...
if __name__ == "__main__":
    asyncio.run(check_moon_boot_uniqlo())