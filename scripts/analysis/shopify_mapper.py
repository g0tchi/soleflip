...
SHOPIFY_ENTITIES = {
    "Product": {
        "fields": ["id", "title", "body_html", "vendor", "product_type", "handle", "tags", "status"],
        "variants": "Variant",
        "images": "ProductImage",
        "options": "ProductOption"
    },
    "Variant": {
        "fields": ["id", "product_id", "title", "price", "sku", "inventory_quantity", "weight", "weight_unit", "option1", "option2", "option3"]
    },
    "Order": {
        "fields": ["id", "name", "email", "total_price", "financial_status", "fulfillment_status", "created_at", "currency", "customer_locale"],
        "line_items": "LineItem",
        "customer": "Customer"
    },
    "LineItem": {
        "fields": ["id", "order_id", "product_id", "variant_id", "title", "quantity", "price", "sku", "vendor"]
    },
    "Customer": {
        "fields": ["id", "email", "first_name", "last_name", "phone", "addresses", "default_address"]
    }
}
