...
async def main():
    ...
    async with db_manager.get_session() as session:
        ...
        print(f"   1. Start with budget products (< EUR 100) for fast turnover")
        print(f"   2. Focus on models with 3+ sizes available")
        print(f"   3. ASICS products dominate the feed - check StockX demand")
        print(f"   4. Jordan products have strong resale history")
        print(f"   5. Use EAN codes to match with StockX pricing")
