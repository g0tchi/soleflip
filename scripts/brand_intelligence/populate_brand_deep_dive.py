...
async def populate_brand_deep_dive():
    ...
    historical_events = [
        ...
        (
            ...
            "Phil Knight and Bill Bowerman start importing Onitsuka Tiger shoes",
            "high",
        ),
        (
            "Nike",
            ...
            "milestone",
            "Nike Brand Launch",
            "Company renamed to Nike, Swoosh logo introduced",
            "critical",
        ),
        (
            "Nike",
            ...
            "milestone",
            "First Nike Shoe",
            "Nike Cortez launched as first Nike-branded shoe",
            "high",
        ),
        ...
        (
            ...
            "Air Jordan brand launched with Michael Jordan",
            "critical",
        ),
        (
            "Nike",
            ...
            "milestone",
            "Air Max Revolution",
            "Air Max 1 introduces visible Air technology",
            "critical",
        ),
        (
            "Nike",
            ...
            "milestone",
            "Flyknit Technology",
            "Revolutionary Flyknit material launched",
            "high",
        ),
        # Adidas History
        (
            ...
            "founded",
            "Adidas Founded",
            "Adolf Dassler founds Adidas after split with brother Rudolf",
            "critical",
        ),
        (
            "Adidas",
            ...
            "milestone",
            "World Cup Victory",
            "Germany wins World Cup wearing Adidas boots with screw-in studs",
            "critical",
        ),
        (
            "Adidas",
            ...
            "milestone",
            "World Cup Ball",
            "First official World Cup ball - Telstar by Adidas",
            "high",
        ),
        (
            "Adidas",
            ...
            "collaboration",
            "Run-DMC Partnership",
            "Hip-hop group Run-DMC popularizes Superstar",
            "high",
        ),
        (
            "Adidas",
            ...
            "milestone",
            "Boost Technology",
            "Revolutionary Boost midsole technology launched",
            "critical",
        ),
        (
            "Adidas",
        ...
        (
            ...
            date(1949, 9, 1),
            "founded",
            "Onitsuka Tiger Founded",
            "Kihachiro Onitsuka starts Onitsuka Tiger",
            "critical",
        ),
        (
            "ASICS",
            ...
            "merger",
            "ASICS Formation",
            "Merger of Onitsuka Tiger, GTO, and JELENK creates ASICS",
            "critical",
        ),
        (
            "ASICS",
            ...
            "milestone",
            "GEL Technology",
            "Revolutionary GEL cushioning system introduced",
            "critical",
        ),
        # New Balance History
        (
        ...
        (
            ...
            "milestone",
            "Boston Marathon",
            "First marathon victory in New Balance shoes",
            "high",
        ),
        (
            "New Balance",
        ...
        (
            ...
            "founded",
            "LEGO Founded",
            "Ole Kirk Christiansen starts wooden toy company",
            "critical",
        ),
        (
            "LEGO",
        ...
        (
            ...
            "milestone",
            "LEGO Brick Patent",
            "Modern LEGO brick design patented",
            "critical",
        ),
        (
            "LEGO",
            ...
            "milestone",
            "Mindstorms Launch",
            "Programmable robotics sets launched",
            "high",
        ),
        # Crocs History
        (
            ...
            "founded",
            "Crocs Founded",
            "Founded by Scott Seamans, Lyndon Hanson, George Boedecker Jr.",
            "critical",
        ),
        (
            "Crocs",
        ...
        (
            ...
            "founded",
            "Telfar Founded",
            "Telfar Clemens starts gender-neutral fashion brand",
            "medium",
        ),
        (
            "Telfar",
            ...
            "milestone",
            "Shopping Bag Launch",
            "Iconic Telfar Shopping Bag introduced",
            "critical",
        ),
        (
            "Telfar",
            ...
            "milestone",
            "Bushwick Birkin",
            'Bag nicknamed "Bushwick Birkin" - viral cultural moment',
            "critical",
        ),
    ]
    ...
    brand_attributes = [
        ...
        (
            ...
            "target_audience",
            "primary_demographic",
            "Football fans and Streetwear enthusiasts",
        ),
