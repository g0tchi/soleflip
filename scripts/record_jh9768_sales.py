...
async def record_sales():
    ...
    async with async_session() as session:
        ...
        print('-'*60)
        print('1. Size 39 1/3: 58 EUR - ROI: {:.2f}%'.format(
            (sales[0]['sale_price'] - Decimal('6.01') - sales[0]['purchase_price_gross']) / sales[0]['purchase_price_gross'] * 100
        ))
        print('2. Size 38:     56 EUR - ROI: {:.2f}%'.format(
            (sales[1]['sale_price'] - Decimal('5.82') - sales[1]['purchase_price_gross']) / sales[1]['purchase_price_gross'] * 100
        ))
