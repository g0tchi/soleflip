...
class CIPipelineValidator:
                ...
                if high_severity > 0:
                    ...
                    checks.append(
                        (
                            ...
                            False,
                            f"{high_severity} high severity issues found",
                        )
                    )
                else:
                    checks.append(
                        (
                            "Bandit security scan",
                            True,
                            f"{medium_severity} medium, 0 high severity issues",
                        )
                    )
    ...
    def generate_report(self):
        ...
        if passed_tests == total_tests:
            ...
            self.log(
                f"❌ {total_tests - passed_tests} tests failed. Fix issues before deployment.",
                "ERROR",
            )
            return False
