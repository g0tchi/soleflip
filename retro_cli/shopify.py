...
class ShopifyManager:
    ...
    def list_products(self, limit: int = 50) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for i, product in enumerate(products[:20], 1):  # Show first 20
                ...
                print(colored_text(f"    Type: {product_type} | Vendor: {vendor} | Status: ", "dim"), end="")
    ...
    def sync_inventory(self):
        ...
        try:
            ...
            print(colored_text(f"Processing {len(products)} products, {total_variants} variants", "bright_white"))
    ...
    def export_catalog(self):
        ...
        try:
            ...
            with open(output_file, 'w', newline='', encoding='utf-8') as csvfile:
                ...
                # Headers
                headers = [
                    'ID', 'Title', 'Handle', 'Product Type', 'Vendor', 'Status',
                    'Created At', 'Updated At', 'Tags', 'Variant Count'
                ]
            ...
            print(colored_text(f"✅ Exported {len(all_products):,} products to: {output_file}", "bright_green"))
