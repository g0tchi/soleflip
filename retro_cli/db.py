...
class DatabaseManager:
    ...
    def list_tables(self):
        ...
        if not self.check_connection():
            ...
            print(colored_text(f"Currently configured: {self.config.database.host}:{self.config.database.port}", "dim"))
    ...
    def export_data(self):
        ...
        try:
            ...
            with self.get_session() as session:
                ...
                print(colored_text(f"✅ Exported {len(rows):,} rows to: {output_file}", "bright_green"))
